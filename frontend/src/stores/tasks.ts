...
const MOCK_TASKS: Task[] = [
  {
    ...
    projectId: 1, area: '', dueDate: '', blockedReason: '', blockedBy: '',
  ...
  },
  {
    ...
    projectId: 2, area: '', dueDate: '', blockedReason: '', blockedBy: '',
  ...
  },
  {
    ...
    projectId: 1, area: '', dueDate: '', blockedReason: 'Needs team review on PR #234', blockedBy: '3',
